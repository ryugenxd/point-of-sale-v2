                ...
                <div class="card w-100">
                    ...
                    <div class="modal fade" id="TambahData" tabindex="-1" aria-labelledby="TambahDataModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="TambahDataModalLabel">Tambah Data Stuan</h5>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="data-tabel" width="100%" class="table table-striped table-bordered text-nowrap border-bottom dataTable no-footer dtr-inline collapsed">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#simpan').on('click',function(){
                if($(this).text() === "ubah"){
                    Fetch.update('products/units',{name:$("#name").val(),description:$("#description").val()},CallBack);
                }else{
                    Fetch.save("products/units", {name:$("#name").val(),description:$("#description").val()},CallBack);
                }
            });
        ...
        $(document).on("click",".update",function(){
            let id = $(this).attr('id');
            $("#modal-button").click();
            $("#TambahDataModalLabel").text("Ubah Data Jenis");
            $("#simpan").text("ubah");
            $.ajax({
                url:'{{url('/')}}/products/units/detail/'+id,
                type:"get",
