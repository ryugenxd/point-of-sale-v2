    ...
    <div class="container-fluid">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="TambahDataModalLabel">Tambah Data Pemasok</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="website" class="form-control" id="website" autocomplete="off">
                                    </div>
                                    <div class="form-group mb-3">
                            ...
                            <table id="data-tabel" width="100%" class="table table-striped table-bordered text-nowrap border-bottom dataTable no-footer dtr-inline collapsed">
                                <thead class="bg-blue text-bold">
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">Sulrel</th>
        ...
        $(document).ready(function(){
            ...
            $(document).on("click",".update",function(){
                let id = $(this).attr('id');
                $("#modal-button").click();
                $("#TambahDataModalLabel").text("Ubah Data Pemasok");
                $("#simpan").text("ubah");
                $.ajax({
                    url:'{{url('/')}}/suppliers/detail/'+id,
                    type:"get",
